...
class Materias(models.Model):
    ...
    # Días en formato JSON (string)
    dias = models.TextField(null=True, blank=True)

    # Horario
    hora_inicio = models.CharField(max_length=50, null=True, blank=True)
    hora_final = models.CharField(max_length=50, null=True, blank=True)
