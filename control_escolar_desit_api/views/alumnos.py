...
class AlumnosView(generics.CreateAPIView):
 ...
 # Actualizar datos del alumno
    ...
    def put(self, request, *args, **kwargs):
        ...
        # Actualizar campos DEL ALUMNO (modelo Alumnos)
        ...
        return Response({"message": "Alumno actualizado correctamente", "alumno": AlumnoSerializer(alumno).data },status=200)
    ...
    def delete(self, request, *args, **kwargs):
        alumno = get_object_or_404(Alumnos, id=request.GET.get("id"))
        try:
            alumno.user.delete() # Esto eliminará también el alumno por la relación OneToOne
